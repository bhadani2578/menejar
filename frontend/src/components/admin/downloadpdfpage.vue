<template>
  <div>
    ...
    <section
      id="desk"
      class="static statement view public invoice"
      ref="document"
    >
      ...
      <form
        novalidate=""
        autocomplete="off"
        id="view_public_invoice"
        accept-charset="UTF-8"
        data-form-type="statement"
        data-statement-type="invoice"
        data-statement-action="view_public"
        class="form_standard"
        data-handler-action=""
        data-object-id="d7ad27e8ff85433fa1eeed145973fb7b"
        data-success-message=""
      >
        <input
          type="hidden"
          name="statement[statement_status]"
          value="unsent"
        />
        <div class="flippable">
          <div class="board front">
            <div id="page" class="page" style="margin-top: 40px">
              <div>
                <input type="hidden" name="statement[type]" value="invoice" />
                <input type="hidden" name="statement[item_order]" value="" />
                <input
                  type="hidden"
                  name="statement[number_format]"
                  value="1"
                />
                <input
                  type="hidden"
                  name="statement[number_precision]"
                  value="2"
                />
                <section class="statement_section">
                  <div class="statement_contacts">
                    <div class="form_row address_from">
                      <div class="form_heading">
                        <label>From</label>
                      </div>
                      <div class="address relative">
                        <p>
                          {{ this.cname }}<br />{{ this.uaddress }}<br />{{
                            this.ucity
                          }}, {{ this.ustate }}, {{ this.upincode }}<br />{{
                            this.ucountry
                          }}<br />{{ this.taxname_one }}<br />{{
                            this.taxname_two
                          }}
                        </p>
                      </div>
                    ...
                    <div
                      class="form_row address_to"
                      data-identifier="autocomplete_wrapper"
                    >
                      <div class="form_heading">
                        <label>To</label>
                      </div>
                      <div class="address relative">
                        <p>{{ this.name }}</p>
                        {{ this.caddress }}<br />{{ this.ccity }},
                        {{ this.cstate }}{{ this.cpincode }}<br />{{
                          this.ccountry
                        }}<br />{{ this.taxno }}
                      </div>
                    </div>
                ...
                <div class="product-table">
                  <ul class="item_rows">
                    <li class="one_item_line no_border">
                      <ul class="item_row no_border">
                        <li class="item_column name_description">
                          <h2 class="item_column_heading">
                            <b style="font-weight: bold !important"
                              >Description</b
                            >
                          </h2>
                        </li>
                        <li class="item_column quantity">
                          <h2 class="item_column_heading">
                            <b style="font-weight: bold !important">Quantity</b>
                          </h2>
                        </li>
                        <li class="item_column unit">
                          <h2 class="item_column_heading">
                            <b style="font-weight: bold !important">Rate</b>
                          </h2>
                        </li>
                        <li class="item_column amount">
                          <h2 class="item_column_heading">
                            <b style="font-weight: bold !important">Amount</b>
                          </h2>
                        </li>
                      </ul>
                    </li>
                  </ul>
                  <ul class="item_rows item_area" id="drag_item_list">
                    <li
                      class="one_item_line actual"
                      data-parent-identifier="one_item_line"
                      data-id="1"
                      data-type="item"
                      v-for="item in items"
                      :key="item.id"
                      ...
                      <ul class="item_row">
                        <li class="item_column name_description">
                          <div class="inner">
                            <div
                              id="item_textarea_1"
                              class="item_textarea_container"
                            >
                              <p
                                class="item_textarea view_statement_textarea_replacement"
                              >
                                {{ item.description }}
                              </p>
                              <div
                                class="files_area file_upload_1"
                                data-fileupload-id="1"
                              >
                                <div
                                  class="tag date"
                                  id="date_tag_1"
                                  ...
                                  style="display: none"
                                >
                                  <a class="close_item"></a>
                                  <div class="inside">
                                    <span class="filename" data-real-date=""
                                      >Jan 01 1970</span
                                    >
                                  </div>
                                </div>
                          ...
                          <div class="inner">
                            <div class="quantity_input">
                              <input
                                ...
                                disabled=""
                                name="statement[item_quantity]"
                                placeholder="Quantity"
                                type="text"
                                data-input-restriction="number"
                                data-trigger="calculation"
                                data-calculation="quantity"
                        ...
                        <li class="item_column unit">
                          <div class="inner">
                            <div class="unit_input">
                              <input
                                disabled=""
                                name="statement[item_rate]"
                                placeholder="Unit Price"
                                type="text"
                                data-input-restriction="number"
                                data-trigger="calculation"
                                data-calculation="rate"
                                data-autocomplete-fill="rate"
                                style="font-size: 14px !important"
                                v-model="item.price"
                              />
                              <div class="unit_lower"></div>
                            </div>
                          </div>
                        </li>
                        <li class="item_column amount">
                          <div class="inner">
                            <div class="total_input">
                              <input
                                disabled=""
                                class="with_addon total no_border_radius_left"
                                name="statement[item_amount]"
                                data-trigger="calculation"
                                data-format-number="precision"
                                data-calculation="line_total"
                                placeholder="0.00"
                                type="text"
                                style="font-size: 14px !important"
                                v-model="item.amount"
                ...
                <div class="totals">
                  <div class="totals_container">
                    <ul class="statement_amount_container">
                      <li class="statement_amount">
                        ...
                        <input
                          ...
                          disabled=""
                          data-format-number="precision"
                          v-model="this.subtotal"
                          data-calculation="subtotal"
                        />
                      </li>
                    </ul>
                    <!-- <div id="tax_discount_shipping_wrapper">
                      <ul
                        class="statement_amount_container tds total tax"
                        data-tds-type="tax"
                      >
                        <li class="statement_amount">
                          <div class="col">
                            Tax (<span data-currency="code"
                              >{{ this.tax }} %</span
                            >)
                          </div>
                          <label
                            ...
                            type="text"
                            disabled=""
                            data-calculation="item_tax_result"
                            >{{ this.taxvalue }}</label
                          >
                        </li>
                      </ul>
                    ...
                    <div
                      id="tax_discount_shipping_wrapper"
                      v-for="(tax, k) in this.tax_list"
                      :key="k"
                    >
                      <ul
                        class="statement_amount_container tds total tax"
                      ...
                      >
                        <li class="statement_amount">
                          <div class="col">
                            {{ tax.tax_name }} (<span data-currency="code"
                              >{{ tax.tax_rate }}%</span
                            >)
                          </div>
                          <label
                            ...
                            disabled=""
                            data-calculation="item_tax_result"
                            >{{ tax.tax_amount }}</label
                          >
                        </li>
                      </ul>
                    </div>
                    <div id="item_tax_discount_shipping_wrapper"></div>
                    <ul class="statement_amount_container">
                      <li class="statement_amount" style="border-bottom: none">
                        <div class="col">
                          <b style="font-weight: bold !important">Total</b>
                          (<span data-currency="code">{{ this.currency }}</span
                          >)
                        </div>
                        <strong
                          ><input
                            class="col no_input bold"
                            type="text"
                            disabled=""
                            data-format-number="precision"
              ...
              <footer>
                <p>
                  <strong style="font-weight: bold !important">Email: </strong
                  >{{ this.email }}
                </p>
  ...
  methods: {
    async start() {
      const response = await axios.get(
        `${base_url}/download_invoice/${this.$route.params.id}`
      );
      console.log("path id" + this.$route.params.id);
      console.log("donwload api call start");
      console.log(response);
      console.log("donwload api call end");
      this.cname = response.data.cname;
      this.uaddress = response.data.uaddress;
      this.ucity = response.data.ucity;
      this.ustate = response.data.ustate;
      this.upincode = response.data.upincode;
      this.ucountry = response.data.ucountry;
      this.admin_id = response.data.uid;
      if (response.data.taxname_one && response.data.taxno_one) {
        this.taxname_one =
          response.data.taxname_one + ": " + response.data.taxno_one;
      }
      if (response.data.taxname_two && response.data.taxno_two) {
        this.taxname_two =
          response.data.taxname_two + ": " + response.data.taxno_two;
      }
      if (response.data.client_type == "Organization") {
        this.name = response.data.organization;
      } else {
        this.name = response.data.name;
      }
      this.caddress = response.data.caddress;
      this.ccity = response.data.ccity;
      if (response.data.cstate) {
        this.cstate = response.data.cstate + ", ";
      }
      this.cpincode = response.data.cpincode;
      this.ccountry = response.data.ccountry;
      this.taxno = response.data.taxno;
      this.invoice_no = response.data.invoice_no;
      const res = await axios.post(
        `${base_url}/forpdftabledata/${this.invoice_no}`
      );
      ...
      if (this.items.length == 5) {
        ...
        $("#page").removeClass("highlight");
      }
      this.date = this.convertDate(response.data.date);
      this.due_date = this.convertDate(response.data.due_date);
      ...
      this.taxvalue = parseFloat(
        (response.data.subtotal * response.data.tax) / 100
      ).toFixed(2);
      this.email = response.data.email;
      this.notes = response.data.notes;
      var element = document.getElementById("desk");
      var filename = "Invoice " + `${this.invoice_no}` + ".pdf";
      var doc = new jsPDF("p", "mm", "a4");
      doc.html(element, {
        callback: function (pdf) {
          this.image = response.data.image;
          var imgData = `${base_url}/static/file_1648182519935.png`;
          var totalPages = pdf.internal.getNumberOfPages();
          for (var i = 1; i <= totalPages; i++) {
            pdf.setPage(i);
            if (i == 1) {
              pdf.setFontSize(25).text("Invoice", 13, 16);
            }
            // for image - > x,y,width,height
            pdf.addImage(imgData, "PNG", 150, 8, 50, 10);
          }
          // Save the PDF
          pdf.save(filename);
        },
...
.product-table .one_item_line {
  display: block !important;
}

.product-table .item_column {
  display: inline-block !important;
}

.product-table .item_row {
  display: block !important;
  width: 100%;
}

.product-table .item_column.name_description {
  width: 55%;
  vertical-align: middle;
}

.product-table .item_column.quantity {
  width: 15%;
  vertical-align: middle;
}

.product-table .item_column.unit {
  width: 15%;
  vertical-align: middle;
}

.product-table .item_column.amount {
  width: 15%;
  vertical-align: middle;
}

.product-table .item_column_heading {
  line-height: 35px;
}
...
#desk.statement.view
  .board:not(.inputs_enabled)
  [data-currency="code"]:not(.total) {
  tab-index: -1;
...
@font-face {
  ...
  src: url(/fonts/FriendlyFont.eot) format("embedded-opentype"),
    url(/fonts/FriendlyFont.woff) format("woff"),
    url(/fonts/FriendlyFont.otf) format("opentype");
  font-style: normal;
  font-weight: 400;
}
...
b,
strong {
  font-family: "pn-sb", "Open Sans", "Gill Sans MT", "Gill Sans", Corbel, Arial,
    sans-serif;
...
body {
  font-family: "pn-r", "Open Sans", "Gill Sans MT", "Gill Sans", Corbel, Arial,
    sans-serif;
  font-size: 14px;
  line-height: 1.4;
  color: #333333;
...
.table_contact_autocomplete.open.filled input[type="text"],
.table_contact_autocomplete.open.filled input[type="text"]:focus {
  background: #e0e0e2;
  cursor: default;
  pointer-events: none;
}

.table_contact_autocomplete.open.filled
  input[type="text"]
  + .remove_contact:before {
  color: #9d9d9d;
  font-family: "Ionicons";
  content: "\f129";
  font-size: 14px;
...
.dropdown-menu {
  ...
  box-shadow: none;
  box-shadow: 0 2px 8px 0 rgba(75, 75, 87, 0.2);
}
...
.sidebar_menu
  ...
  li
  a.reports
  span:not(.coming_soon):not(.hide_compact):before {
  content: "\e7fb";
}
...
.sidebar_menu
  ...
  li
  a.business_settings
  span:not(.hide_mobile):not(.hide_compact):before {
  content: "\e673";
}
...
#desk.dashboard ul.legend li.received:hover {
  background: rgba(61, 160, 123, 0.3);
}
...
#desk
  .board.multiple_boxes.subscription_plans
  .page.professional
  .header:before {
  content: "\e7ca";
}
...
#desk .board.multiple_boxes.subscription_plans .page .stretch {
  height: 480px;
  /* requested by andreas @ticket #223 */
}
...
#desk.settings
  ...
  .page.settings
  section
  a.settings_edit_business_info:before {
  content: "\e613";
}
...
#desk.settings
  ...
  .page.settings
  section
  a.settings_system_preferences:before {
  content: "\e673";
}
...
#desk.settings
  ...
  .page.settings
  section
  a.settings_statement_preferences:before {
  content: "\e6b5";
}
...
#desk.settings
  ...
  .page.settings
  section
  a.settings_payment_integrations:before {
  content: "\e750";
}
...
.sidebar_menu
  ...
  .select_business
  ul.dropdown-menu
  li:not(.heading):not(.logout):not(.selected):hover {
  background: rgba(0, 0, 0, 0.05);
}
...
.x_window {
  ...
  -moz-border-radius: 3px;
  -webkit-border-radius: 3px;
  box-shadow: 0 2px 8px 0 rgba(75, 75, 87, 0.9);
  /*overflow: hidden*/
}
...
.autocomplete-suggestions {
  ...
  display: block;
  box-shadow: 0 2px 8px 0 rgba(75, 75, 87, 0.2);
  -webkit-box-shadow: 0 2px 8px 0 rgba(75, 75, 87, 0.2);
  -moz-box-shadow: 0 2px 8px 0 rgba(75, 75, 87, 0.2);
  font-size: 13px;
  list-style: none;
  padding: 5px;
  margin: 0;
...
.shakeInput {
  ...
  -webkit-animation: shakeInput 0.5s;
  border-color: #8c8c91;
}
...
table td.blank.loading:before {
  ...
  -webkit-animation: pace-spinner 0.6s infinite linear;
  animation: pace-spinner 0.6s infinite linear;
...
.tag.date {
  display: none;
  background: rgba(43, 161, 225, 0.95);
...
#desk.settings
  form[data-connection-type="individual"]
  .form_row.double.individual,
#desk.settings
  form[data-connection-type="individual"]
  section.double.individual,
#desk.settings
  form[data-connection-type="organization"]
  .form_row.double.organization {
...
#desk.statement.view
  .board:not(.inputs_enabled)
  .statement_amount_container.tds
  .statement_amount {
  padding: 7px;
}
...
#desk.statement.view
  .page.recurring
  section.flex
  .form_row.inline.profile_status
  a,
#desk.statement.view
  .page.statement_info
  section.flex
...
@media screen and (max-width: 800px) {
  ...
  #desk.settings
    .form_row:not(.custom_period):not(.individual):not(.organization) {
    margin-top: 0;
    display: block !important;
    width: 100%;
    padding: 0 !important;
  ...
  table td.connection_id input[type="checkbox"],
  table.team td input[type="checkbox"],
  table.categories td input[type="checkbox"] {
  }
  ...
  table.categories tr td:nth-child(4),
  td.statement_expiration_date,
  ...
  table.team tr td:nth-child(2) span.name,
  table.categories td:nth-child(2) span.name {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
    width: 125px;
  ...
  table.modify_language tr td:nth-child(1):before {
    content: "Location: ";
    display: inline-block;
    font-family: "pn-sb", "Open Sans", "Gill Sans MT", "Gill Sans", Corbel,
      Arial, sans-serif;
  }
...
@media screen and (max-width: 800px) {
  ...
  #desk.statement.view
    .statement_amount_container:not(.total_due)
    .statement_amount,
  #desk.statement.view
    .board:not(.inputs_enabled)
    .statement_amount_container.tds
